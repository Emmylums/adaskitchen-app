...
import { faChevronDown, faDollarSign, faEdit, faPlus, faPrint, faSearch, faShoppingCart, faStar, faTimes, faTrash, faUpload, faUser, faUtensils } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      ...
      <div className='md:flex md:justify-end'>
        <div className={`pt-32 px-5 ${isSidebarOpen ? "md:w-[70%] lg:w-[75%]" : "md:w-full"} transition-all duration-500`}>
          <div>
            <h2 className="text-2xl font-bold text-own-2 mb-6">Invoice Management</h2>
